...
# it is the state of the game at a particular instance
class init_state(object):

	# A function to initialize the board for the very first time
	def __init__(self,init_array,startr,startc,maxr,maxc):

		active_cells = []

		# Finding the active cells on board
...
# A class containing all the functions that help the game to move ahead
class game(object):
	...
	# Function to make the game's life move one step ahead
	...
	# Function to find whether a new cell at a position will be an alive or dead cell
